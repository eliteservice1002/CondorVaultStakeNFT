...
//reference to this contract https://github.com/spore-engineering/BSC-ETH-NFT-STORE-CONTRACTS
//bsc mainnet contract https://bscscan.com/address/0x43310f33Cb4e77d8f0A709Cb6F0be32D22c6Dbcd
contract NFTSaleSpore is AccessControl, ReentrancyGuard, Pausable {

    IERC20 public spore = IERC20(0x77f6A5f1B7a2b6D6C322Af8581317D6Bb0a52689);
    
    address burner_wallet = address(0x79207f009733a9770edE24f7Fd7b8e02b2A25222);
    ...
    function purchase(address to, uint256 id, uint256 amount, bytes memory data) public nonReentrant whenNotPaused {
        require(_NFTPrices[id] != 0, 'Min price not met');
        
        uint256 totalPurchaseAmount = _NFTPrices[id]*amount;
      
        require(spore.balanceOf(to) >= totalPurchaseAmount, 'Min price not met');
        require(spore.transferFrom(_msgSender(), burner_wallet, totalPurchaseAmount), 'transfer failed');
